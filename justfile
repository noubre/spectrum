...
@getbalance wallet_name:
  bitcoin-cli --rpcport=8081 --rpcwallet={{wallet_name}} getbalance
  echo "Getting balance from wallet {{wallet_name}}:"

@listunspent wallet_name:
  bitcoin-cli --rpcport=8081 --rpcwallet={{wallet_name}} listunspent
  echo "Listing unspent outputs from wallet {{wallet_name}}:"
